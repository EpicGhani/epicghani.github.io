...
const ct = {
     ...
     */
    version: '3.2.0',
    meta: [{"name":"JettyCat","author":"ComigoGames","site":"https://ctjs.rocks/","version":"1.0.0"}][0],
    get width() {
...
ct.inputs.addAction('Poof', [{"code":"touch.Any"}]);
...
ct.rooms.templates['InGame'] = {
    ...
    width: 1080,
    height: 1920,
    objects: JSON.parse('[{"x":320,"y":832,"opacity":1,"tint":16777215,"scale":{"x":0.65,"y":0.65},"rotation":0,"exts":{},"customProperties":{},"template":"PotatoCat"}]'),
    bgs: JSON.parse('[{"texture":"BG_Sky","depth":-1000,"exts":{"movementX":0,"movementY":0,"parallaxX":0.5,"parallaxY":1,"repeat":"repeat","scaleX":1,"scaleY":1,"shiftX":0,"shiftY":0}},{"texture":"BG_Ground","depth":-100,"exts":{"movementX":0,"movementY":0,"parallaxX":1,"parallaxY":1,"repeat":"repeat-x","scaleX":1,"scaleY":1,"shiftX":0,"shiftY":1736}}]'),
    tiles: JSON.parse('[{"depth":-10,"tiles":[],"extends":{}}]'),
    backgroundColor: '#000000',
    
    onStep() {
        /* room InGame — core_OnStep (On frame start event) */
{
// If there is no cat in the room…
if (!ct.templates.list['PotatoCat'].length) {
    // stop further execution
    return;
}

// Substract elapsed time from the timer
this.obstacleTimer -= ct.delta;
// If the timer is up…
if (this.obstacleTimer <= 0) {
    // Wind it again
    this.obstacleTimer += ct.speed * 2;
...
{
// This is where we will store the number of collected stars
this.stars = 0;

// Adds a UI layer on top of the main one
this.mainUi = ct.rooms.append('UI_InGame', {
    isUi: true
});

// Wind up the timer for tube creation
this.obstacleTimer = ct.speed * 5;
...
ct.rooms.templates['MainMenu'] = {
    ...
    width: 1080,
    height: 1920,
    objects: JSON.parse('[{"x":540,"y":384,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"Logo"},{"x":540,"y":960,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"Button_Play"}]'),
    bgs: JSON.parse('[{"texture":"BG_Sky","depth":-1000,"exts":{"movementX":-0.5,"movementY":0,"parallaxX":1,"parallaxY":1,"repeat":"repeat","scaleX":1,"scaleY":1,"shiftX":0,"shiftY":0}},{"texture":"BG_Ground","depth":-100,"exts":{"movementX":0,"movementY":0,"parallaxX":1,"parallaxY":1,"repeat":"repeat-x","scaleX":1,"scaleY":1,"shiftX":0,"shiftY":1736}}]'),
    tiles: JSON.parse('[{"depth":-10,"tiles":[],"extends":{}}]'),
    backgroundColor: '#000000',
...
ct.rooms.templates['UI_InGame'] = {
    name: 'UI_InGame',
    group: 'ungrouped',
    width: 1080,
    height: 1920,
    objects: JSON.parse('[{"x":128,"y":128,"tx":0.75,"ty":0.75,"exts":{},"customProperties":{},"opacity":1,"tint":16777215,"rotation":0,"scale":{"x":1,"y":1},"template":"StarCounter"},{"x":960,"y":128,"exts":{},"customProperties":{},"opacity":1,"tint":16777215,"rotation":0,"scale":{"x":1,"y":1},"template":"Button_Pause"},{"x":512,"y":960,"exts":{},"customProperties":{},"opacity":1,"tint":16777215,"rotation":0,"scale":{"x":1,"y":1},"template":"PressHint"}]'),
    bgs: JSON.parse('[]'),
    tiles: JSON.parse('[{"depth":-10,"tiles":[],"extends":{}}]'),
    backgroundColor: '#000000',
...
ct.rooms.templates['UI_Paused'] = {
    name: 'UI_Paused',
    group: 'ungrouped',
    width: 1080,
    height: 1920,
    objects: JSON.parse('[{"x":540,"y":1088,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"Button_Continue"},{"x":540,"y":576,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"Paused_Heading"}]'),
    bgs: JSON.parse('[]'),
    tiles: JSON.parse('[{"depth":-10,"tiles":[],"extends":{}}]'),
    backgroundColor: '#000000',
    ...
    onCreate() {
        /* room UI_Paused — core_OnRoomStart (On room start event) */
{
this.alpha = 0;
...
ct.rooms.templates['UI_OhNo'] = {
    name: 'UI_OhNo',
    group: 'ungrouped',
    width: 1080,
    height: 1920,
    objects: JSON.parse('[{"x":540,"y":384,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"OhNo_Heading"},{"x":540,"y":1344,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"Button_Play"},{"x":540,"y":832,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"EndGame_Star_Counter"}]'),
    bgs: JSON.parse('[]'),
    tiles: JSON.parse('[{"depth":-10,"tiles":[],"extends":{}}]'),
    backgroundColor: '#000000',
    ...
    onCreate() {
        /* room UI_OhNo — core_OnRoomStart (On room start event) */
{
this.alpha = 0;
...
ct.templates.list['Logo'] = [];
        
ct.templates.templates["Button_Play"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
    ...
    onCreate: function () {
        /* template Button_Play — core_OnPointerClick (OnPointerClick event) */
...
ct.templates.list['Button_Play'] = [];
        
ct.templates.templates["PotatoCat"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
    ...
    texture: "PotatoCat",
    onStep: function () {
        /* template PotatoCat — core_OnStep (On frame start event) */
{
this.move();
...
/* template PotatoCat — core_OnActionRelease (OnActionRelease event) */
...
/* template PotatoCat — core_OnActionDown (OnActionDown event) */

if (ct.actions['Poof'].down) {
    let value = ct.actions['Poof'].value;
    
this.gravity = this.gravityAcceleration;
this.addSpeed(ct.delta * this.gravityAcceleration * 2, -90);

}
/* template PotatoCat — core_OnActionPress (OnActionPress event) */
...
/* template PotatoCat — place_collisionCGroup (Collision with a group event) */
{
    const other = ct.place.occupied(this, 'Obstacle');
...
.then(() => {
    ...
    onCreate: function () {
        /* template PotatoCat — core_OnCreate (On create event) */
{
this.speed = 10;
this.direction = 0;
...
ct.templates.list['PotatoCat'] = [];
        
ct.templates.templates["Tube"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
    ...
    onCreate: function () {
        /* template Tube — core_OnCreate (On create event) */
{
// Randomize tube's height by changing its texture
...
ct.templates.templates["Star"] = {
    ...
    texture: "Star",
    onStep: function () {
        /* template Star — place_collisionTemplate (Collision with a template event) */
{
    const other = ct.place.meet(this, 'PotatoCat');
    if (ct.templates.valid(other)) {
        this.kill = true;
ct.room.stars ++;
    }
...
this.angle = Math.sin(this.wiggleTime) * 5;
    ...
    onDestroy: function () {
        /* template Star — core_OnDestroy (On destroy event) */
{
ct.emitters.fire('Stars', this.x, this.y);
}

    },
    onCreate: function () {
        /* template Star — core_OnCreate (On create event) */
{
this.wiggleTime = 0;
}
...
ct.templates.templates["StarCounter"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
    ...
    onDraw: function () {
        /* template StarCounter — core_OnDraw (On frame end event) */
{
this.label.text = ct.room.stars;
}
    ...
    onCreate: function () {
        /* template StarCounter — core_OnCreate (On create event) */
{
this.label = new PIXI.Text('0', ct.styles.get('Orange'));
this.label.x = 130;
this.label.y = -60;
this.label.scale.x = this.label.scale.y = 1 / 0.75;
...
ct.templates.list['StarCounter'] = [];
        
ct.templates.templates["Button_Pause"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
    ...
    onCreate: function () {
        /* template Button_Pause — core_OnPointerClick (OnPointerClick event) */
this.interactive = true;
this.on('pointertap', () => {
...
ct.templates.list['Button_Pause'] = [];
        
ct.templates.templates["Paused_Heading"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
...
ct.templates.list['Paused_Heading'] = [];
        
ct.templates.templates["Button_Continue"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
    ...
    onCreate: function () {
        /* template Button_Continue — core_OnPointerClick (OnPointerClick event) */
this.interactive = true;
this.on('pointertap', () => {
...
ct.templates.list['Button_Continue'] = [];
        
ct.templates.templates["OhNo_Heading"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
...
ct.templates.list['OhNo_Heading'] = [];
        
ct.templates.templates["PressHint"] = {
    depth: 50,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
    ...
    texture: "PressHint",
    onStep: function () {
        /* template PressHint — core_OnStep (On frame start event) */
{
...
if (ct.actions.Poof.pressed) {
    ...
    onCreate: function () {
        /* template PressHint — core_OnCreate (On create event) */
{
this.pulsePhase = 0;
}
...
ct.templates.list['PressHint'] = [];
        
ct.templates.templates["EndGame_Star_Counter"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
    ...
    onCreate: function () {
        /* template EndGame_Star_Counter — core_OnCreate (On create event) */
{
if (!('JettyCat_HighScore' in localStorage)) {
    localStorage['JettyCat_HighScore'] = ct.room.stars;
} else if (localStorage['JettyCat_HighScore'] < ct.room.stars) {
    localStorage['JettyCat_HighScore'] = ct.room.stars;
}

var scoreText = `Your score: ${ct.room.stars}
...
ct.templates.list['EndGame_Star_Counter'] = [];
        
ct.templates.templates["PotatoCat_Stunned"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    animationFPS: 30,
    playAnimationOnStart: false,
    ...
    visible: true,
    group: "ungrouped",
    texture: "PotatoCat_Stunned",
    onStep: function () {
        /* template PotatoCat_Stunned — core_OnStep (On frame start event) */
{
this.move();
}
    ...
    onCreate: function () {
        /* template PotatoCat_Stunned — core_OnCreate (On create event) */
{
this.gravity = 2;
...
ct.templates.list['PotatoCat_Stunned'] = [];
...
(function resAddon(ct) {
    ...
    ct.res = {
        ...
        textures: {},
        skeletons: {},
        groups: [{"fonts":{"ungrouped":[]},"textures":{"ungrouped":["BG_Ground","Button_Play","Jetty_Cat","Button_Pause","PotatoCat","PotatoCat_Stunned","Star","BG_Sky","Pause","Circle_08","Tube_01","Tube_03","Tube_04","Tube_02","OhNo","PressHint"]},"styles":{"ungrouped":["Orange"]},"rooms":{"ungrouped":["InGame","MainMenu","UI_InGame","UI_Paused","UI_OhNo"]},"sounds":{"ungrouped":[]},"emitterTandems":{"ungrouped":["Jet","Stars"]},"templates":{"ungrouped":["Logo","Button_Play","PotatoCat","Tube","Star","StarCounter","Button_Pause","Paused_Heading","Button_Continue","OhNo_Heading","PressHint","EndGame_Star_Counter","PotatoCat_Stunned"]}}][0],
        /**
        ...
        loadGame() {
            ...
            const tiledImages = [{"BG_Ground":{"source":"./img/t0.png","shape":{"type":"rect","top":0,"bottom":191,"left":0,"right":1080},"anchor":{"x":0,"y":0}},"BG_Sky":{"source":"./img/t1.png","shape":{"type":"rect","top":0,"bottom":1920,"left":0,"right":1080},"anchor":{"x":0,"y":0}}}][0];
            const sounds = [[]][0];
            const bitmapFonts = [{}][0];
